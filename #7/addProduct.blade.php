...
@section('content')
    ...
    <form method="POST" action="/admin/add-products" enctype="multipart/form-data" class="w-75">
        @csrf
        ...
        <div class="mb-3">
            ...
            <textarea name="description" class="form-control" placeholder="Opis" required></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="price" class="form-control" step="0.01" placeholder="Cena" required>
        </div>

        <div class="mb-3">
            <label for="image" class="form-label">Link do slike (URL)</label>
            <input type="text" name="image" class="form-control" placeholder="URL slike">
        </div>
